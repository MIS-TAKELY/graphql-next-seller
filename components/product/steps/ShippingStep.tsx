    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <FormField label="Free Delivery Options">
            ...
            >
              ...
              <SelectItem value="all_nepal">Free delivery across Nepal</SelectItem>
              <SelectItem value="selected_provinces">Free delivery in selected provinces</SelectItem>
            </ValidatedSelect>
          </FormField>
              ...
              <div className="space-y-2">
                {nepalProvinces.map((province) => (
                  <label key={province} className="flex items-center gap-2 cursor-pointer">
                    <Checkbox
                      checked={formData.freeDeliveryProvinces?.includes(province)}
                      onCheckedChange={(checked) => {
                        const currentProvinces = formData.freeDeliveryProvinces || [];
                        const updatedProvinces = checked
                          ? [...currentProvinces, province]
                          : currentProvinces.filter((p) => p !== province);
                        updateFormData("freeDeliveryProvinces", updatedProvinces);
                      }}
                    />
      ...
      {/* <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
        ...
        <div className="space-y-2">
          <label className="flex items-center gap-2 cursor-pointer">
            <Checkbox
              checked={formData.noInternationalShipping}
              onCheckedChange={(checked) =>
                updateFormData("noInternationalShipping", checked)
              }
            />
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            <Checkbox
              checked={formData.restrictedStates}
              onCheckedChange={(checked) =>
                updateFormData("restrictedStates", checked)
              }
            />
            <span className="text-sm text-amber-800">
              Restricted to certain states/regions
            </span>
          </label>
        </div>
      </div> */}
